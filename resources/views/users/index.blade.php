            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr class="hover:bg-slate-50">
                    ...
                    <td class="px-4 py-3">
                        ...
                        <span class="text-xs bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded-full">{{ __('Branch Manager') }}</span>
                        @else
                        <span class="text-xs bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full">{{ __('Worker') }}</span>
                        @endif
                    </td>
                ...
                @empty
                <tr><td colspan="5" class="px-4 py-8 text-center text-slate-400">{{ __('No branch managers or workers found.') }}</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
