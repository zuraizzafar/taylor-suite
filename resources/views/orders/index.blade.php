        ...
        <table class="w-full text-sm">
            <thead class="bg-slate-50 text-slate-600">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left font-medium">{{ __('Order Date') }}</th>
                    <th class="px-4 py-3 text-left font-medium">{{ __('Delivery Date') }}</th>
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                @empty
                <tr><td colspan="8" class="px-4 py-8 text-center text-slate-400">{{ __('No orders found.') }}</td></tr>
                @endforelse
            </tbody>
        </table>
