...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .invoice-title { font-size: 20px; font-weight: 800; color: #0f172a; text-transform: uppercase; letter-spacing: 1px; font-family: sans-serif; }
    .invoice-no {
    ...
    .invoice-dates { font-size: 10px; color: #475569; margin-top: 4px; line-height: 1.3; }
    ...
    table.items tbody td { padding: 5px 8px; border-bottom: 1px solid #f1f5f9; font-size: 11px; }
    table.items tfoot td { padding: 4px 8px; background: #f1f5f9; border-top: 1.5px solid #cbd5e1; font-weight: 600; font-size: 10.5px; }
    ...
    /* ── Measurements ─────────────────────────────────── */
    .meas-wrap { border: 1px solid #e2e8f0; border-radius: 6px; margin-bottom: 10px; overflow: hidden; }
    .meas-title-row { background: #f1f5f9; padding: 4px 8px; font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; color: #475569; font-family: sans-serif; }
    .meas-section-hdr { font-size: 8px; font-weight: 700; text-transform: uppercase; color: #94a3b8; padding: 4px 8px 2px; background: #fff; border-top: 1px solid #f1f5f9; font-family: sans-serif; }
    table.meas-grid { width: 100%; border-collapse: collapse; }
    table.meas-grid td { padding: 3px 6px; font-size: 9.5px; border-right: 1px solid #f1f5f9; border-bottom: 1px solid #f1f5f9; }
    table.meas-grid td:first-child { border-right: none; }
    .meas-lbl { color: #94a3b8; font-size: 7.5px; display: block; margin-bottom: 1px; }
    .meas-val { font-weight: 700; color: #0f172a; font-size: 9.5px; }
